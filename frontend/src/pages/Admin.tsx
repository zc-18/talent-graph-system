  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        <div className="flex items-center gap-3"><div className="w-11 h-11 shrink-0 rounded-xl bg-slate-900 grid place-items-center shadow-card"><ShieldCheck className="w-5 h-5 text-accent/40" /></div><div><h1 className="text-2xl font-extrabold text-slate-900">系统管理</h1><p className="text-sm text-slate-500">账号与组织、公共知识审核、审计与使用分析</p></div></div>
